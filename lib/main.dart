...
class _MyAppState extends State<MyApp> {
  ...
  void setUsername(nUsername) {
    print(nUsername);
    this.setState(this.username = nUsername);
  }

  void setPassword(nPassword) {
    print(nPassword);
    this.setState(this.password = nPassword);
  }
          ...
          Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Image.asset("assets/ark.jpg"),
              ),
              Expanded(
                child: Container(),
              ),
